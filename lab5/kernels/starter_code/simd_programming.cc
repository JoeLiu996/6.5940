        ...
        for (int col = 0; col < n; col++) {
            ...
            for (int q = 0; q < num_block; q++) {
                ...
                */
                ...
                int8x16_t lower_half = vreinterpretq_s8_u8(vandq_u8(w0, mask_low4bit));
                int8x16_t upper_half = vreinterpretq_s8_u8(vshrq_n_u8(w0, 4));
                ...
                lower_half = vsubq_s8(lower_half, offsets);
                upper_half = vsubq_s8(upper_half, offsets);
                ...
                int_sum0 = vdotq_s32(int_sum0, a0, lower_half);
                int_sum0 = vdotq_s32(int_sum0, a1, upper_half);
                float s_0 = *s_a++ * *s_w++;
